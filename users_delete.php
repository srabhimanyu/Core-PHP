...
<head>
  ...
  <h3><a href="users_delete.php?view">View Users</a></h3>
  <?php
  $con = mysqli_connect("localhost:3308","root","","mytest");
   ...
   if(isset($_GET['view'])){
	 ...
	 echo "
	  ...
	  <tr align='center'>
		 ...
		 <td> $u_email </td>
		 <td> $u_pass </td>
		 <td><a href='users_delete.php?del=$u_id'> Delete </a></td>
		 <td> <a href='users_delete.php?edit=$u_id'> Edit </a></td>
	   </tr>
	   	   ";
   ...
   // Deleting Data From the Table
    ...
    if(isset($_GET['del'])){
		...
		echo "<script> window.open('users_delete.php?view','_self')</script>";
